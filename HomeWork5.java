    ...
    **/
    ...
    public static class Person {
        ...
        public String announce() {
            return ("Person " + PERSON_NAME + " имеет характеристики: " + health + " здоровья и " + protection + " защиты");
        }

        void takeDamage(Integer damage) throws Exception{
            int dam = (damage-protection);
            if((health-dam)<0) throw new PersonDead("Персонаж погиб.");
            if(dam < 0) throw new Exception();
    ...
    public static class Mage extends Person{
        ...
        public Mage(String personName) {
            super();
        }

        public String announce() {
            return ("Mage " + MAGE_NAME + " имеет характеристики: " + this.health + " здоровья и " + this.protection + " защиты");
        }

        public void takeDamage(Integer damage) throws Exception{
            int dam = (damage - protection - this.health % 10);
            if(dam < 0) throw new Exception();
            if(this.health < 0) throw new Exception();
            if((this.health-dam)<=0) throw new PersonDead("Персонаж погиб.");
    ...
    public static class Archer extends Person{
        ...
        public int protection = 12;

        public Archer(String personName) {
            super();
        }

        public String announce() {
            return ("Archer " + ARCHER_NAME + " имеет характеристики: " + health + " здоровья и " + protection + " защиты");
        }
        public void takeDamage(Integer damage) throws Exception{
            int dam = (damage - protection + this.health % 10);
            if(dam < 0) throw new Exception();
